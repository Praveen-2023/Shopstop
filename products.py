...
>>>>>>> 7d3483573724e77da9871ee364481b5913d41064
    ...
    def create_product():
        try:
            ...
            if 'shop_id' in data:
<<<<<<< HEAD
                cur.execute(f"SELECT 1 FROM {DB_NAME}.shop WHERE shop_id = %s", (data['shop_id'],))
=======
...
<<<<<<< HEAD
                cur.execute(f"SELECT 1 FROM {DB_NAME}.supplier WHERE supplier_id = %s", (data['supplier_id'],))
=======
...
<<<<<<< HEAD
            cur.execute(f"""
                INSERT INTO {DB_NAME}.product (name, category, supplier_id, shop_id, price, stock_quantity)
=======
            cur.execute("""
