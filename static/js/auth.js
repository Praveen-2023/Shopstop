...
<<<<<<< HEAD
    console.log('User role:', userRole || 'Not available');
=======
...
<<<<<<< HEAD
        userRoleElement.className = role && (role.toLowerCase() === 'admin' || role === 'Admin') ? 'badge bg-danger ms-2' : 'badge bg-primary ms-2';
=======
...
function isAdmin() {
    const userRole = localStorage.getItem('userRole');
<<<<<<< HEAD
    return userRole && (userRole.toLowerCase() === 'admin' || userRole === 'Admin');
=======
